...
public final class SystemConfig {
	...
	public static final String TRIGGER_TYPE_GE = "ge";//bigger than
	public static final String TRIGGER_TYPE_LE = "le";//smaller than
	...
	public static final String OFFSET_TYPE_OPEN = "open";
	public static final String OFFSET_TYPE_CLOSE = "close";
	...
	//public static final String mysql_url = "jdbc:mysql://127.0.0.1:3306/market_db?serverTimezone=UTC&characterEncoding=utf-8";//
	public static final String mysql_url = "jdbc:mysql://192.168.0.103:3306/market_db?serverTimezone=UTC&characterEncoding=utf-8";
	...
	public static final String LOG_FILE_PATH = BASE_DIR + "trade_record.log";
